namespace Waffle.Dispatcher
{
    ...
    public class DefaultHandlerTypeResolver : IHandlerTypeResolver
    {
        ...
        /// </returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification = "We deliberately ignore all exceptions when building the cache.")]

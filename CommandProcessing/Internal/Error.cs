namespace CommandProcessing.Internal
{
    ...
    internal static class Error
    {
        ...
        {
            return new ArgumentOutOfRangeException(parameterName, actualValue, Error.Format(Resources.ArgumentMustBeGreaterThanOrEqualTo, minValue));
        }
        ...
        {
            return new ArgumentOutOfRangeException(parameterName, actualValue, Error.Format(Resources.ArgumentMustBeLessThanOrEqualTo, maxValue));
        }

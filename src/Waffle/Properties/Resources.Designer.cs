...
namespace Waffle.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Cannot call method &apos;{0}&apos; on handler &apos;{1}&apos; because the action method is a generic method..
        /// </summary>
        internal static string CommandHandlerDescriptor_CannotCallOpenGenericMethods {
            get {
                return ResourceManager.GetString("CommandHandlerDescriptor_CannotCallOpenGenericMethods", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string CommandHandlerDescriptor_NoConverterForGenericParamterTypeExists {
            get {
                return ResourceManager.GetString("CommandHandlerDescriptor_NoConverterForGenericParamterTypeExists", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Command handler not found for command type: {0}, and command result type: {1}..
        /// </summary>
        internal static string CommandHandlerNotFoundException_ReturnsType {
            get {
                return ResourceManager.GetString("CommandHandlerNotFoundException_ReturnsType", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Command handler not found for command type: {0}..
        /// </summary>
        internal static string CommandHandlerNotFoundException_VoidType {
            get {
                return ResourceManager.GetString("CommandHandlerNotFoundException_VoidType", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string DefaultHandlerInvoker_InvalidHandlerResult {
            get {
                return ResourceManager.GetString("DefaultHandlerInvoker_InvalidHandlerResult", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string DefaultHandlerInvoker_NullHandlerResponse {
            get {
                return ResourceManager.GetString("DefaultHandlerInvoker_NullHandlerResponse", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string DefaultHandlerInvoker_NullHandlerResult {
            get {
                return ResourceManager.GetString("DefaultHandlerInvoker_NullHandlerResult", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Elapsed=&apos;{0} millisecond(s)&apos;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Processing of the request resulted in an exception. Please see the response returned by the &apos;Response&apos; property of this exception for details..
        /// </summary>
        internal static string HandlerResponseExceptionMessage {
            get {
                return ResourceManager.GetString("HandlerResponseExceptionMessage", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to No IQueryContext factory found for &apos;{0}&apos;..
        /// </summary>
        internal static string QueryService_NoQueryContext {
            get {
                return ResourceManager.GetString("QueryService_NoQueryContext", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to IQueryContext factory for &apos;{0}&apos; return null..
        /// </summary>
        internal static string QueryService_NoQueryContextFactory {
            get {
                return ResourceManager.GetString("QueryService_NoQueryContextFactory", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Executed handler for message &apos;{0}&apos;.
        /// </summary>
        ...
        /// </summary>
        internal static string UnreachableCode {
            get {
